<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="图标" prop="imgUrl" align="center" width="220">
        <template slot-scope="{row}">
          <iframe :src="row.imgUrl" height="200" width="300" frameborder="0" allowfullscreen style="overflow: scroll; overflow-x: hidden; overflow-y: auto;overflow: scroll;overflow-x: auto; overflow-y: hidden;"></iframe></template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 600px;height: 100%; margin-left:60px;">
        ...
        <el-form-item label="图标地址" prop="imgUrl">
          <el-input v-model="temp.imgUrl" placeholder="图标地址" clearable style="width: 300px" class="filter-item"></el-input> 
        </el-form-item>
      </el-form>
...
<script>
import { gonggaoTypeList, gonggaoTypeSave, gonggaoTypeUpdate, gonggaoTypeDelete } from '@/api/gonggao/gonggaoType'
...
export default {
  ...
  methods: {
    getList() {
      ...
      gonggaoTypeList(this.listQuery).then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          gonggaoTypeSave(this.temp).then(() => {
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          gonggaoTypeUpdate(tempData).then(() => {
    ...
    handleDelete(row, index) {
      this.$confirm('确认删除?', '提示', {
        ...
        gonggaoTypeDelete(row.id,).then((res) => {
          if (res.code == 20000) {
            this.$notify({
              title: 'Success',
